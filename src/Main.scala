...
class Main extends Application {
  ...
  override def start(stage: Stage): Unit = {
    ...
    // Decidimos que os modelos que intersectam o volume de visualização mudam de cor para branco e quando deixam de o
    //intersectar ficam invisíveis
    ...
    scene.setOnMouseClicked((event) => {
      ...
      changeColour(oct1)
      //scaleOctree(1.5, oct1) Usámos este evento para testar o exercício t4 para ver se o tamanho dos modelos da oct1 aumentam/diminuem
    })
